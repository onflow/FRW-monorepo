...
describe('isVaultIdentifier', () => {
  ...
  describe('Invalid Vault Identifiers', () => {
    it('should return false for non-vault/non-nft resource types', () => {
      ...
      expect(isVaultIdentifier('A.1654653399040a61.FlowToken.Token')).toBe(false);
    });
  ...
  describe('Edge Cases', () => {
    it('should handle case sensitivity correctly', () => {
      ...
      // Vault/NFT suffix must be exact case
      expect(isVaultIdentifier('A.1654653399040a61.FlowToken.vault')).toBe(false);
      expect(isVaultIdentifier('A.1654653399040a61.FlowToken.VAULT')).toBe(false);
      expect(isVaultIdentifier('A.1654653399040a61.FLOAT.nft')).toBe(false);
      expect(isVaultIdentifier('A.1654653399040a61.FLOAT.NFTs')).toBe(false);
    });
