...
export enum ErrorCode {
  ...
  ACCOUNT_CREATION_MISSING_DATA = 'ACCOUNT-03',
  ACCOUNT_REGISTRATION_FAILED = 'ACCOUNT-04',
  ACCOUNT_FIREBASE_AUTH_FAILED = 'ACCOUNT-05',
  ACCOUNT_MNEMONIC_SAVE_FAILED = 'ACCOUNT-06',
