import { AddressbookService } from '@/network/api/goService';
import { AddressBookResponse } from '@/types/bridge';
...
export class AddressBookService {
   ...
   */
  static async getAddressBook(): Promise<AddressBookResponse> {
    try {
      ...
      } else if (response.data && response.data.contacts === null) {
        // Handle case where contacts is explicitly null
        return {
          contacts: [],
        };
