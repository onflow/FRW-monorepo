...
const SvgSendConfirmation = (props: SvgProps) => (
  <Svg
  ...
  >
    ...
    />
    <Path fill="#fff" d="m93.486 33.567-7.778 4.198 4.198 7.779 7.779-4.199z" />
    <Path
      fill="#fff"
    ...
    />
    <Path fill="#00EF8B" d="m82.13 49.734 7.773-4.196-4.195-7.773-7.773 4.196z" />
...
export default SvgSendConfirmation;
