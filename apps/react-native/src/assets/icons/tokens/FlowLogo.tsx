...
const SvgFlowLogo = (props: SvgProps) => (
  <Svg
  ...
  >
    <G clipPath="url(#flow-logo_svg__a)">
      ...
      <Path
        ...
        d="M18.1 35.2c9.72 0 17.6-7.88 17.6-17.6S27.82 0 18.1 0 .5 7.88.5 17.6s7.88 17.6 17.6 17.6"
      />
      <Path fill="#fff" d="M25.824 14.847h-4.97v4.97h4.97z" />
      <Path
        fill="#fff"
      ...
      />
      <Path fill="#16FF99" d="M15.886 19.814h4.967v-4.967h-4.967z" />
    </G>
    <Defs>
      <ClipPath id="flow-logo_svg__a">
        <Path fill="#fff" d="M.5 0h35.2v35.2H.5z" />
      </ClipPath>
    </Defs>
  </Svg>
);
