package com.flowfoundation.wallet.widgets.easyfloat.permission.rom
...
object RomUtils {
    ...
    fun checkIsMeizuRom(): Boolean {
        ...
        else systemProperty!!.contains("flyme") || systemProperty.lowercase(Locale.ROOT).contains("flyme")
    }
